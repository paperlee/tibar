 ...
 didFinishPickingMediaWithInfo: (NSDictionary*) info
{
	...
	if (pickerSuccessCallback!=nil){
        ...
        NSString *pngFilePath = [NSString stringWithFormat:@"%@/last.png",docDir];
        NSLog(pngFilePath);
        NSData *imageDate = UIImagePNGRepresentation(image);
        [imageDate writeToFile:pngFilePath atomically:YES];
